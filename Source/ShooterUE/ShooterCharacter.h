...
UCLASS()
class SHOOTERUE_API AShooterCharacter : public ACharacter
{
	GENERATED_BODY()
...
protected:
	...
	* @param Value  The input value from mouse movememt
	*/
	...
	*/
	...
	// Initialize the Ammo with ammo values
